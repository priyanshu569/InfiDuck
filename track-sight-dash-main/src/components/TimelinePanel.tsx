    ...
    <Card className="dashboard-card">
      <div className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-semibold text-foreground">Train Timeline</h3>
        </div>

        <ScrollArea className="h-[400px]">
          <div className="space-y-3">
            {timelineEvents.map((event) => (
              <div key={event.id} className="flex items-center gap-4 p-3 bg-secondary/10 rounded-lg border border-border">
        ...
        <div className="pt-4 border-t border-border">
          <div className="grid grid-cols-3 gap-4 text-center">
            ...
            <div className="space-y-1">
              ...
              <div className="text-lg font-bold text-warning">2.3m</div>
            </div>
            <div className="space-y-1">
